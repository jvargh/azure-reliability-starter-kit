...
~8% of checkouts return 5xx. The availability SLI drops well below 99.9% and the fast-burn alert fires within its short lookback.
...
Adds 600 ms to login, pushing P95 above the 300 ms threshold so the latency SLI budget burns.
