...
.SYNOPSIS
  ...
  Group itself. Reverse of deploy-slo.ps1. Recording rules and the AMW are left
...
Write-Host ''
Write-Host 'Teardown complete. Recreate with: pwsh -File deploy-slo.ps1 -SkipRecordingRules' -ForegroundColor Green
