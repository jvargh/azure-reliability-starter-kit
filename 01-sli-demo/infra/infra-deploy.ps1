...
#   ./infra-deploy.ps1 -ResourceGroup rg-sli-demo -Location eastus2 -PlanSku B1 -GenerateTraffic
...
$root = Split-Path -Parent $PSScriptRoot          # 01-sli-demo/
$infra = $PSScriptRoot                            # 01-sli-demo/infra
